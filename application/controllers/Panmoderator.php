...
class Panmoderator extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->load->view('panitia/moderator/index', $data);
    ...
    public function Tambah(){
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('panitia/header', $data);
            $this->load->view('panitia/moderator/tambah', $data);
            $this->load->view('panitia/footer');
        } else {
            ...
            redirect('index.php/panmoderator');
        }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('panitia/header', $data);
            $this->load->view('panitia/moderator/update', $data);
            $this->load->view('panitia/footer');
        } else {
