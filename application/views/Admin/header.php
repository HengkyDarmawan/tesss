    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/admin/absensi" class="nav-link">
              <i class="nav-icon fas fa-fw fa-user-check"></i>
              <p>Absensi</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/webinar/index" class="nav-link">
              <i class="nav-icon fas fa-fw fa-chalkboard-teacher"></i>
              <p>Seminar / Webinar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/pembicara/index" class="nav-link">
              <i class="nav-icon fas fa-fw fa-user-graduate"></i>
              <p>Pembicara</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/moderator/index" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/admin/profile" class="nav-link">
