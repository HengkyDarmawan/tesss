  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url();?>index.php/admin" class="d-block"><?php echo $user['name']?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/absensi" class="nav-link">
              <i class="nav-icon fas fa-fw fa-user-check"></i>
              <p>Absensi</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/webinar" class="nav-link">
              <i class="nav-icon fas fa-fw fa-chalkboard-teacher"></i>
              <p>Seminar / Webinar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/pembicara" class="nav-link">
              <i class="nav-icon fas fa-fw fa-user-graduate"></i>
              <p>Pembicara</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/moderator" class="nav-link">
