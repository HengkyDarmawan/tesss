              ...
              <div class="card-body">
                <div class="card mb-3" style="max-width: 1080px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?php echo base_url('assets/img/') . $user['image'];?>" alt="User Image">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text">Hp : <?php echo $user['hp']?></p>
                                <p class="card-text">Pekerjaan: <?php echo $user['pekerjaan']?></p>
