    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/panitia" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/panwebinar/index" class="nav-link">
              <i class="nav-icon fas fa-fw fa-chalkboard-teacher"></i>
              <p>Seminar / Webinar</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/panpembicara/index" class="nav-link">
              <i class="nav-icon fas fa-fw fa-user-graduate"></i>
              <p>Pembicara</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/panmoderator/index" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>index.php/panitia/profile" class="nav-link">
