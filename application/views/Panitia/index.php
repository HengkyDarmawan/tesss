                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($dafwebinar['status'] == 'review') { ?>
                                    <a href="<?= base_url(); ?>index.php/panitia/approved/<?= $dafwebinar['id_daftar_webinar']; ?>" class="btn btn-outline-success btn-sm" onclick="return confirm('yakin?');">terdaftar</a>
                                    <a href="<?= base_url(); ?>index.php/panitia/rejected/<?= $dafwebinar['id_daftar_webinar']; ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('yakin?');">ditolak</a>
                                <?php } ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
